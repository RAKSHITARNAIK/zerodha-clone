      ...
      <div className="row p-5 mt-5 border-top text-muted" style={{lineHeight:"1.8" ,fontSize:"1.2em"}}>
        ...
        <div className="col-6 p-5">
            <p>
                ...
                <p>And yet, we are always up to something new every day. Catch up on the latest updates on our blog or see what the media is <a style={{textDecoration:"none"}} href="">saying about us</a> or learn more about our business and product philosophies.</p>
